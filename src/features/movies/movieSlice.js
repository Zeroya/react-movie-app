...
export const fetchAsyncDetailSeries = createAsyncThunk(
  "movies/fetchAsyncDetailSeries",
  async (id) => {
    const response = await movieApi.get(
...
export const getAllFavorites = (state) => state.movies.favorites;
export const { toggleToFavorites } = movieSlice.actions;
