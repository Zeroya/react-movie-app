  ...
  return (
    <div>
      <div className="header">
            ...
            {isActive && (
              ...
              >
                <div className="dropdown-item">
                  <Link
                    to="/search"
                    onClick={(e) => setItTrue(true)}
                    onChange={dispatch(fetchAsyncSearch("naruto"))}
                  >
                    Search
                  </Link>
                </div>
                <div className="dropdown-item">
                  <Link to="/popular" onClick={(e) => setItTrue(false)}>
                    Popular
                  </Link>
                </div>
                <div className="dropdown-item">
                  <Link to="/top" onClick={(e) => setItTrue(false)}>
                    Top Rated
                  </Link>
                </div>
                <div className="dropdown-item">
                  <Link to="/series" onClick={(e) => setItTrue(false)}>
                    Series
                  </Link>
                </div>
              </div>
        ...
        <div className="panel">
          <div
            className="dropdown btn-nodrop "
            style={{ margin: "0px 10px 0px 15px" }}
          >
            <div className="dropdown-item dropdown-btn btn-favorite">
